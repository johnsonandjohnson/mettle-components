...
| [&#8592; Step 8: Linting](?path=/docs/welcome-recipes-scaffold-a-spa-step-8-linting--page) |  | [Step 10: Testing &#8594;](?path=/docs/welcome-recipes-scaffold-a-spa-step-4-services--page)
|:---------|:---------:|---------:|
