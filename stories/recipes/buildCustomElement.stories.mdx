...
<div class="recipe">
  ...
  <div class="flex-col">
    <h1 class="heading">Building a Custom Element</h1>
    <small class="flex"> <img src={BeginerLevel} alt="Beginer Level" height="20" /> Beginner level</small>
