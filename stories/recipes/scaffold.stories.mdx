...
We will need to update Webpack to ensure we can reslove the location for our components.
...
Using the webpack reslove will make it easier to not have to worry about import directories.

The main folders that will be incudled next will be all the files needed for a
