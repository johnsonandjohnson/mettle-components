...
This is an open-source project so all elements can be used without attribution. View the project on <a href="https://github.com/johnsonandjohnson/mettle-components/"><img src={Github} alt="Github" height="15" /> Github.com</a>.
